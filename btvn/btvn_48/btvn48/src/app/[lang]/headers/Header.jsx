import f8Image from "@/app/assets/images/f8-icon.webp";
      ...
      <div className="main-header">
        <div className="title">
          <Link className="image" href="/">
            <Image height={36} width={36} src={f8Image} alt="favicon" />
          </Link>
        ...
        <div>
          <ul className="contact-mode" style={{ listStyle: "none" }}>
            <li className="contact">
              <Link legacyBehavior href="https://fullstack.edu.vn/@son-dang">
