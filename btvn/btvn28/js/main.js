...
var audio = new Audio("./mp3/hat.mp3");
...
var songInfo = `<p>Anh đâu muốn thấy em buồn</p>
  <p>Ca sỹ: Châu Khải Phong</p>`;
...
function handleLyric(time) {
  ...
  var index = lyric.findIndex(function (item) {
    ...
    return (
      time >= sentences[0].startTime &&
      time <= sentences[sentences.length - 1].endTime
    );
  });
  if (index !== -1) {
...
var lyric = `
// 20230918112220
// https://zingmp3.vn/api/v2/lyric/get/lyric?id=Z6AABFU6&BGId=0&ctime=1695010711&version=1.9.68&sig=b490cc98f4fcc01f0654a377944aa32f4912c84ca59ec2df610a69822ce919682cf54e5ef50bc859f164570d568980b214e8cadcdce1ba6fd15bbc5c54903c9d&apiKey=X5BM3w8N7MKozC0B85o4KMlzLZKhV00y
